...
const Footer = () => {
  return (
    ...
    <div className="container">
          ...
          <div className="info">
            ...
            <nav>
              <ul>
                <li>
                  <a href="#">
                    <i className="fa fa-twitter" /> <b>Get Shit Done</b> The best
                    kit in the market is here, just give it a try and let us...
                    <hr className="hr-small" />
                  </a>
                </li>
                <li>
                  <a href="#">
                    <i className="fa fa-twitter" /> We've just been featured on{" "}
      ...
      <hr />
      <div className="copyright">© Creative Tim, made with love</div>
    </div>
  </footer>
